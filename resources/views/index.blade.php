    ...
    <main class="admin-main-content" id="admin-main-content">
        ...
        <div class="admin-section" id="admin-section-editor-cms">
            ...
            <div class="admin-card">
                <form action="{{ route('cms.settings.update') }}" method="POST" class="cms-form" style="gap:15px;">
                    @csrf
...
{{-- ================================================================ --}}
        ...
        <div class="container hero-container">
            ...
            <div class="hero-image-container">
                <div class="glass-card hero-glass-card">
                    <img src="{{ $settings['hero_image_url'] ?? 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=600&auto=format&fit=crop' }}" alt="Featured Product" class="hero-image">
                    <div class="floating-badge badge-top"><i class="bx bxs-star yellow"></i> 4.9 Rating</div>
                    <div class="floating-badge badge-bottom"><i class="bx bxs-check-shield green"></i> Garansi Resmi 1 Tahun</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="stats">
        <div class="container stats-container">
            ...
            <div class="stat-card"><h3>{{ $products->count() }}+</h3><p>Produk Terdaftar</p></div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="filter-controls">
                ...
                <div class="category-tabs">
                    <a href="{{ route('home', ['search' => request('search')]) }}#products" class="tab-btn {{ !request('category') ? 'active' : '' }}">Semua</a>
                    @foreach($categories as $cat)
                        <a href="{{ route('home', ['category' => $cat->slug, 'search' => request('search')]) }}#products" class="tab-btn {{ request('category') == $cat->slug ? 'active' : '' }}">{{ $cat->name }}</a>
                    @endforeach
                </div>
            </div>
